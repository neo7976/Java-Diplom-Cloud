...
insert into users(login, password) values ('neo8745', '12345678');
insert into users(login, password) values ('panya12', '1111222');
insert into users(login, password) values ('meloman', '12344321');
